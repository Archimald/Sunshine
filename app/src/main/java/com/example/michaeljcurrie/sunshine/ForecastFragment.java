package com.example.michaeljcurrie.sunshine;
...
public class ForecastFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        forecasts.add("Thurs - Rainy - 64/52");
        ...
        protected String[] doInBackground(String... params) {
            {
                ...
                try {
                    ...
                    URL url = new URL("http://api.openweathermap.org/data/2.5/forecast/daily?id=4907907&cnt=7&mode=json&units=metric");
                    ...
                    Log.v(LOG_TAG, "The string: " + forecastJsonStr);
